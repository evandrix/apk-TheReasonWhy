            ...
            if (mStateChanged) {
                ...
                Log.v(LOG_TAG, "Ending State: "
                                + (mIsConnected ? "Connected "
                                                : "Not Connected ")
                                + (mIsCellularConnection ? "Cellular "
                                                : "WiFi ")
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            final APKExpansionPolicy aep = new APKExpansionPolicy(mContext,
                            new AESObfuscator(getSALT(), mContext
                ...
                public void allow(int reason)
                {
                    try {
                        ...
                        try {
                            ...
                            Class<?> serviceClass = DownloaderService.this
                                            .getClass();
