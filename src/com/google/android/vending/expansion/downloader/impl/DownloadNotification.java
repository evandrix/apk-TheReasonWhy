    ...
    implements IDownloaderClient
{
    ...
    public void onDownloadStateChanged(int newState)
    {
        ...
        if (newState != mState) {
            mState = newState;
            if (newState == IDownloaderClient.STATE_IDLE
                            || null == mContentIntent) {
                return;
            }
            ...
            case IDownloaderClient.STATE_DOWNLOADING:
                ...
                stringDownloadID = Helpers
                                .getDownloaderStringResourceIDFromState(newState);
                ongoingEvent = true;
                break;
            ...
            mCurrentNotification.setLatestEventInfo(mContext, mCurrentTitle,
                mCurrentText, mContentIntent);
            if (ongoingEvent) {
    ...
    public void onDownloadProgress(DownloadProgressInfo progress)
    {
        ...
        if (progress.mOverallTotal <= 0) {
            ...
            mNotification.setLatestEventInfo(mContext, mLabel, mCurrentText,
                mContentIntent);
            ...
            mCurrentNotification = mCustomNotification
